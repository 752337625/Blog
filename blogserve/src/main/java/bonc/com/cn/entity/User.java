...
public class User implements Serializable{
	 ...
	 * 用户名
	 */
	@Column(columnDefinition = "varchar(50) COMMENT '用户名'",nullable=false)
	 ...
	 * 是否同意服务条款
	 */
	@Column(columnDefinition = "tinyint(1) COMMENT '当前是否同意服务条款'",nullable=false)
	private int clause=1;

	/**
	 * 当前账户是否被锁定
	 */
	@Column(columnDefinition = "tinyint(1) COMMENT '当前账户是否被锁定'",nullable=false)
	private int locked;
	
	/**
	 * 用户注册手机号
	 */
	@Column(columnDefinition = "varchar(100) COMMENT '用户注册手机号'",nullable=false)
	 ...
	 * 用户注册邮箱
	 */
	@Column(columnDefinition = "varchar(100) COMMENT '用户注册邮箱'",nullable=false)
	 ...
	 * 个人描述
	 */
	@Column(columnDefinition = "varchar(400) COMMENT '个人描述'",nullable=false)
